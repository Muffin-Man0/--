...
function (t) {
    var e = function (e, i) {
        ...
        t.fn.tree.defaults, i),
        this.$element.on("click", ".tree-item", t.proxy(function (t) {
            this.selectItem(t.currentTarget)
        },
        this)),
        this.$element.on("click", ".tree-folder-header", t.proxy(function (t) {
    ...
    e.prototype = {
        ...
        populate: function (e) {
            ...
            r.show(),
            this.options.dataSource.data(e.data(),
            function (o) {
                r.hide(),
                t.each(o.data,
                function (r, o) {
        ...
        selectItem: function (e) {
            ...
            r = [];
            if (this.options.multiSelect ? t.each(n,
            function (e, n) {
                var o = t(n);
        ...
        selectFolder: function (e) {
            ...
            l = a.eq(0);
            o.find(".fa.fa-folder").length ? (i = "opened", n = ".fa.fa-folder", r = "fa fa-folder-open", l.show(), a.children().length || this.populate(o)) : (i = "closed", n = ".fa.fa-folder-open", r = "fa fa-folder", l.hide(), this.options.cacheItems || l.empty()),
            s.find(n).eq(0).removeClass("fa fa-folder fa-folder-open").addClass(r),
            this.$element.trigger(i, o.data())
        },
    ...
    t.fn.tree = function (i, n) {
        var r, o = this.each(function () {
            ...
            s = o.data("tree"),
            a = "object" == typeof i && i;
            s || o.data("tree", s = new e(this, a)),
            "string" == typeof i && (r = s[i](n))
        });
        return void 0 === r ? o : r
    },
    t.fn.tree.defaults = {
