...
; (function ($, window, document, undefined) {
   ...
   *  删除子节点 
   */
    Tree.prototype.removeNode = function (identifiers, options) {

        this.forEachIdentifier(identifiers, options, $.proxy(function (node, options) {
            this.setRemoveNode(node, options);
        }, this));
    ...
    Tree.prototype.setRemoveNode = function (node, options) {
        if (node.nodes == null) node.nodes = [];
        if (options.node) {
            this.nodes[node.parentId].nodes.pop();
