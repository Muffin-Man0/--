...
function playCallback() {
    ...
    if (point.Status == "行驶")
    {
        arrlin.push(new BMap.Point(point.Longitude, point.Latitude));
    }
    ...
    Typolyline = new BMap.Polyline(arrlin,
    { strokeColor: "#00ff21" });
    map.addOverlay(Typolyline);
    ...
    createStatus(point, index, false);
    //回放时显示infowindow
            ...
            if (data.flag == 1) {
                $.each(data.obj, function (i) {
                    ...
                    if (Number(this.a) == 0 && Number(this.o) == 0) {
                        ...
                        var pointbd_encrypt = GPS.bd_encrypt(latlon.lat, latlon.lon);
                        this.a = pointbd_encrypt.lat;
                        this.o = pointbd_encrypt.lon;
                    }
                });
